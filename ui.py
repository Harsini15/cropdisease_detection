...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        if np.argmax(model_out) == 0:   #index of max value
            str_label = 'healthy'
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users/PlantDisease/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/PlantDisease/testpicture"
